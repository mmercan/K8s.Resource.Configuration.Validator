...
public interface IKubernetesClient
{
    ...
    Task<Watcher<object>> Watch(string Group, string ApiVersion, string PluralName,
        TimeSpan timeout,
    ...
    Task<List<JToken>> ListClusterCustomObject(string Group, string Version, string Plural);
    /// <summary>
    /// Fetch and return List of Namespaces.
    /// </summary>
    /// <returns>Task<IList<V1Namespace>> </returns>
    Task<IList<V1Namespace>> ListNamespaces();
}
