...
public abstract class CustomResourceMeta<V1ObjectMeta, TSpec> : IKubernetesObject<V1ObjectMeta>
{
...
public abstract class CustomResourceMeta<V1ObjectMeta, TSpec, TStatus> : IKubernetesObject<V1ObjectMeta>
{
