...
namespace Sentinel.Core.K8s.Models.Istio
{
    public class HttpRoute
    {
        ...
        public IList<HttpMatchRequest> Match { get; set; } = default!;
        ...
        public IList<HttpRouteDestination> Route { get; set; } = default!;
        ...
        public HttpRedirect Redirect { get; set; } = default!;
        ...
        public HttpRewrite Rewrite { get; set; } = default!;
        ...
        public HttpRetry Retries { get; set; } = default!;
        ...
        public HttpFaultInjection Fault { get; set; } = default!;
        ...
        public Destination Mirror { get; set; } = default!;
        ...
        public Percent MirrorPercentage { get; set; } = default!;
