...
namespace Sentinel.Core.K8s.Models.Istio
{
    public class HttpMatchRequest
    {
        ...
        public IDictionary<string, string> SourceLabels { get; set; } = default!;
        ...
        public IList<string> Gateways { get; set; } = default!;

        /// <summary>
        /// Gets/sets query parameters to match.
        /// </summary>
        [JsonProperty(PropertyName = "queryParams")]
        public IDictionary<string, StringMatch> QueryParams { get; set; } = default!;
        ...
        public IDictionary<string, StringMatch> WithoutHeaders { get; set; } = default!;
