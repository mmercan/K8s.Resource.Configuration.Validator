...
namespace Sentinel.Core.BackgroundServices
{
    public abstract class BackgroundServiceWithHealthCheck : BackgroundService
    {
        ...
        public BackgroundServiceHealthCheck  ReportHealthy(string message = "") => bgHealthCheck.ReportHealthy(message);
        public BackgroundServiceHealthCheck  ReportUnhealthy(string message = "") => bgHealthCheck.ReportUnhealthy(message);
        public BackgroundServiceHealthCheck  ReportDegraded(string message = "") => bgHealthCheck.ReportDegraded(message);
